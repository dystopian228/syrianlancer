    ...
    <div id="addP-form" class="addProject-div col-md-6 col-centered ">
        ...
        <div class="row">
            <div class="col-md-6 md-form">
                <p>وصف المشروع</p>
                <textarea id="textarea-char-counter" name ="description" class="border border-warning  md-textarea text-box-addProject " length="200" rows="8"></textarea>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <select  id="palance" name="palance" class=" border border-warning text-box-addProject form-control skills-select">
                    <option value="">15-25 ألف</option>
                    <option value=""> 25-50 ألف</option>
                    <option value="">50-125 ألف</option>
                    <option value=""> 125-250 ألف</option>
                    <option value=""> 250-400 ألف</option>
                    <option value=""> 400-500 ألف</option>
                </select>
            ...
            <div class="col-md-6">
                <p>مدة التسليم</p>
                <input type="text" name="duration" class="border border-warning form-control " placeholder="">
